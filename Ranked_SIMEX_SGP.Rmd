...
```{r, cache=TRUE, echo=FALSE, include=FALSE, GOFplots}
  ...
  gofSGP(dat, years='2017', content_areas="MATHEMATICS", use.sgp="SGP_ORDER_1", output.format=c("PNG", "SVG"))
	gofSGP(dat, years='2017', content_areas="MATHEMATICS", use.sgp="SGP_SIMEX_ORDER_1", output.format=c("PNG", "SVG"))
	gofSGP(dat, years='2017', content_areas="MATHEMATICS", use.sgp="SGP_SIMEX_RANKED_ORDER_1", output.format=c("PNG", "SVG"))
